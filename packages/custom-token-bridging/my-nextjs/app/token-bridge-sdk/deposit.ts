...
import { getArbitrumNetwork, registerCustomArbitrumNetwork, ParentToChildMessageStatus, Erc20Bridger } from '@arbitrum/sdk';
import {percentIncrease} from "@/token-bridge-sdk/utils";
import { customConduitNetwork } from '@/config/network';
import { balanceOfERC20 } from '@/token-bridge-sdk/utils';
...
const childProvider = new ethers.providers.JsonRpcProvider(CHILD_RPC);
const parentProvider = new ethers.providers.JsonRpcProvider(PARENT_RPC);
const OPERATOR_KEY: string = "0xf70920bc474b73aa90bff0d7ac295cd840b72375aeea12b20ff88460dac80f53"
const PROXY_KEY: string = "0x99b0eb9ce810284e3b7269b2f5fb16679d2062a931a791c191f4035e3f807cd2"
